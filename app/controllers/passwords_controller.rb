class PasswordsController < ApplicationController
  ...
  def create
    ...
    if @user
      ...
      redirect_to new_passwords_path, danger: 'Aucun utilisateur ne correspond a cet email'
    end
  end
  ...
  def edit
    ...
    if @user.recover_password == params[:token]
      ...
      redirect_to new_password_path, danger: 'Le token invalide'
    end
  end
  ...
  def update
    ...
    if @user.recover_password == user_params[:recover_password]
      ...
      if @user.valid?
        ...
        redirect_to profil_path, success: 'Mot de passe modifer'
      end
    else
      render 'edit'
    end
